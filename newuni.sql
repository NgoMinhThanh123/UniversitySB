...
INSERT INTO `credit_price` VALUES (1,2022,400000,'MQPAN'),(11,2022,510000,'MGDTC'),(12,2022,640000,'TCT'),(13,2022,840000,'TH'),(14,2022,750000,'MLUAT'),(15,2022,750000,'MTCNH'),(16,2022,750000,'MKETOAN'),(17,2022,750000,'MKIEMTOAN'),(18,2022,750000,'MNNA'),(20,2022,840000,'MCNTT'),(21,2022,840000,'MHTTTQL'),(22,2022,760000,'MCNSH'),(23,2025,8000000,'MCNSH');
...
INSERT INTO `education_program` VALUES (1,'Công nghệ thông tin','NMTH','12023'),(2,'Công nghệ thông tin','CSLT','12023'),(3,'Công nghệ thông tin','DSTT','12023'),(4,'Công nghệ thông tin','KTMT','22023'),(5,'Công nghệ thông tin','KTLT','22023'),(6,'Công nghệ thông tin','GT','22023');
...
INSERT INTO `faculty` VALUES ('CNSH','Công nghệ sinh học '),('CNTT','Công nghệ thông tin'),('KINHTE','Kinh tế và Quản lý công'),('KTKT','Kế toán - Kiểm toán'),('LUAT','Luật'),('NN','Ngoại ngữ'),('QTKD','Quản trị kinh doanh'),('TCNH','Tài chính - Ngân hàng'),('TCT','Toán, Lý luận chính trị'),('XD','Xây dựng'),('XHHCTXHDNA','XHH - CTXH - DNA');
...
INSERT INTO `score_percent` VALUES (1,0.6,0.4,'CSDL'),(2,0.7,0.3,'CSLT'),(3,0.7,0.3,'KTLT'),(4,0.5,0.5,'LUATKT'),(5,0.7,0.3,'OOP'),(6,0.5,0.5,'TANC1'),(7,0.5,0.5,'TANC2'),(8,0.5,0.5,'TANC3'),(9,0.5,0.5,'TANC4'),(10,0.5,0.5,'TANC5'),(11,0.7,0.3,'TKW'),(12,0.5,0.5,'CNMLN'),(13,0.5,0.5,'DCSVN');
...
INSERT INTO `semester` VALUES ('12023','Học kì 1',2023,'2023-01-12','2023-03-22'),('12024','Học kì 1',2024,'2023-01-12','2024-03-22'),('22023','Học kì 2',2023,'2023-03-28','2023-04-04'),('32023','Học kì 3',2023,'2024-06-06','2023-08-24');
...
INSERT INTO `subject_semester` VALUES (5,'CSLT','12023'),(6,'KTLT','22023'),(7,'CSDL','32023'),(8,'OOP','32023'),(11,'TKW','12024'),(13,'LUATKT','12024'),(14,'DSTT','12023'),(15,'CNMLN','32023'),(16,'DCSVN','12024'),(17,'LTDD','12024');
...
CREATE TABLE `tuition_fee` (
  ...
  CONSTRAINT `semester3_id` FOREIGN KEY (`semester_id`) REFERENCES `semester` (`id`),
  CONSTRAINT `student9_id` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`)
...
INSERT INTO `tuition_fee` VALUES (9,4440000,1,'2024-04-10','12024','2051052127'),(10,1920000,0,'2024-04-10','32023','2051052000'),(11,1920000,1,'2024-04-10','32023','2051052001'),(12,1920000,0,NULL,'12024','2051052127');
...
-- Dump completed on 2024-04-13 23:46:35
